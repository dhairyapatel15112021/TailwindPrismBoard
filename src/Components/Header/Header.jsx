...
export const Header = () => {
    return (
        <div className='col-span-8 sm:col-span-7 grid grid-cols-5 shadow-md p-2 text-gray-500 items-center'>
            <div className='grid grid-cols-2 p-2 place-items-center  col-span-2 sm:col-span-1'>
                <div className='text-[#1A181E] text-[16px] sm:text-[20px]'>Payments</div>
            ...
            <div className='col-span-2 col-start-3 ml-4 sm:m-0'>
