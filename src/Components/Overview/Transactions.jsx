        ...
        <div>
            ...
            <div className='bg-white p-2 mt-2 rounded-md'>
                <div className='flex justify-between items-center p-2'>
                    <div className='flex items-center justify-between border border-[#999999] rounded-md p-2 w-[20%]'>
                    ...
                    <div className='flex items-center justify-between w-[10%]'>
                        <div className='flex justify-between border border-[##999999] rounded-sm py-1 px-1.5 w-[60%]'>
