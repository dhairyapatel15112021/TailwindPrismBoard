...
export const Order = () => {
    return (
        <div className='grid grid-cols-1 grid-rows-5 p-2'>
            <div className='grid grid-cols-4 grid-rows-1 gap-6 bg-[#F2F2F2] p-2 rounded-md text-[#4D4D4D] text-[12px]'>
            ...
            </div>
            {
                OrderData.map((item, index) => {
                    return (
                        <div>
                            <div className='grid grid-cols-4 grid-rows-1 gap-6 p-2 rounded-md text-[#4D4D4D] text-[12px]'>
                                <div className='ml-2 text-[#146EB4]'>{item.id}</div>
                                <div>{item.date}</div>
                                <div className='place-self-end'>{item.amount}</div>
